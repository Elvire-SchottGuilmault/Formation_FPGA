...
# Buttons
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports button_0]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports button_1]

## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33  PULLTYPE PULLDOWN} [get_ports { resetn }]; #IO_L17P_T2_34 Sch=ja_p[1]
