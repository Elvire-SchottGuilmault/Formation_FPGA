...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports clk]; #set
...
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports led]; #IO_0_35 Sch=led1_b
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports end_counter]; #IO_L22P_T3_AD7P_35 Sch=led1_g
...
connect_debug_port u_ila_0/probe0 [get_nets [list end_counter_OBUF]]
